...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($conn->query($sql) === TRUE) {
        header("Location: /Mercado_SENA/login/login.php");
    } else {
...
<body>
    ...
    <form method="POST" action="/Mercado_SENA/login/register.php">
    ...
    <a href="/Mercado_SENA/login/login.php">¿Ya tienes cuenta? Inicia sesion</a>
</body>
</html>