...
<body>
    ...
    <table border="1">
        ...
        <tr>
            ...
            <td>
                <a href="frm_update_products.php?id=<?= $row['ID_PRODUCTO'] ?>">Editar</a> | 
                <a href="delete_products.php?id=<?= $row['ID_PRODUCTO'] ?>">Eliminar</a>
            </td>
        </tr>
        <?php endwhile; ?>     
    </table>
    <br><br><a href="category.php">Volver a Categoria</a>
</body>
</html>
